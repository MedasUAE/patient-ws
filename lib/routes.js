...
module.exports = function (server, restify) {
    ...
    server.get('/laborder/:consult_id', restify.plugins.conditionalHandler([
    ...
    //get labresult by consult_id & test_id
    server.get('/labresult/:consult_id/:test_id', restify.plugins.conditionalHandler([
