...
sql.doctors.v4 = {};
sql.doctors.v4.columns = ['fromdate','todate','slot_day','appoint_min','appoint_hr']
sql.doctors.v4.query =  "SELECT " + sql.doctors.v4.columns.join(',') +
                        " FROM appointment_sch WHERE doctors_id =  ?" +
                        " AND active_status = 'Y' AND fromdate <= ? AND todate >= ?";
/*  insurar query
