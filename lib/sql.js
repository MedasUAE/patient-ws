...
// patient laborders v1 query by consult_id
sql.laborder = {};
sql.laborder.v1 = {};
sql.laborder.v1.columns = ['test_setup.test_Name', 'consult_labtest.labtest_id', 'consult_labtest.entered_date', 'test_setup.profile_type', 'doctor_consult.office_id'];
sql.laborder.v1.query = "SELECT "+ sql.laborder.v1.columns.join(',') +
                        ...
                        " WHERE consult_labtest.consult_id = ?";
